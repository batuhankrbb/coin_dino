...
class CoinDetailHoursInformationRow extends StatelessWidget {
  const CoinDetailHoursInformationRow({Key? key, required this.data})
      : super(key: key);
      ...
      children: [
        Expanded(
          ...
          child: CoinDetailHoursTableWidget(
            tableTitle: "DETAIL_SCREEN.HOURS_TABLE_24H_TEXT".tr(),
        ...
        Expanded(
          flex: 1,
          child: CoinDetailHoursTableWidget(
            tableTitle: "DETAIL_SCREEN.HOURS_TABLE_7D_TEXT".tr(),
        ...
        Expanded(
          flex: 1,
          child: CoinDetailHoursTableWidget(
              tableTitle: "DETAIL_SCREEN.HOURS_TABLE_14D_TEXT".tr(),
        ...
        Expanded(
          flex: 1,
          child: CoinDetailHoursTableWidget(
              tableTitle: "DETAIL_SCREEN.HOURS_TABLE_30D_TEXT".tr(),
        ...
        Expanded(
          flex: 1,
          child: CoinDetailHoursTableWidget(
              tableTitle: "DETAIL_SCREEN.HOURS_TABLE_60D_TEXT".tr(),
        ...
        Expanded(
          flex: 1,
          child: CoinDetailHoursTableWidget(
              tableTitle: "DETAIL_SCREEN.HOURS_TABLE_1Y_TEXT".tr(),
